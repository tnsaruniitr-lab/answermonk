      ...
      <nav className="w-full border-b border-border sticky top-0 z-50 bg-background">
        <div className="max-w-3xl mx-auto px-6 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signal-consistency" className="text-sm text-muted-foreground flex items-center gap-1.5 transition-colors hover:text-foreground" data-testid="link-signal-consistency">
            ...
            <Link href="/reports/crawlability" className="text-sm text-muted-foreground flex items-center gap-1.5 transition-colors hover:text-foreground" data-testid="link-crawlability">
              <FileSearch className="w-3.5 h-3.5" />
              Crawlability
            </Link>
            <Link href="/reports/geo-landing-page" className="text-sm text-muted-foreground flex items-center gap-1.5 transition-colors hover:text-foreground" data-testid="link-geo-landing">
              <FileSearch className="w-3.5 h-3.5" />
              GEO Report
            </Link>
