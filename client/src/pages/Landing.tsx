...
function LandingInner() {
  ...
  return (
    <div
      className="relative min-h-screen w-full overflow-x-clip flex flex-col font-sans"
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {cat.items.map((item) => (
                        <div key={item.name} className="flex flex-col items-center gap-1">
                          ...
                          <span style={{ fontSize: 9.5, color: "#9ca3af", fontWeight: 500 }}>{item.name}</span>
                        </div>
                      ))}
                    </div>
                  </div>
