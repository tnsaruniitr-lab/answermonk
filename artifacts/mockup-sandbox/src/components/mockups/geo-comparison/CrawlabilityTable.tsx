...
export function CrawlabilityTable() {
  return (
    <div className="min-h-screen bg-slate-50 font-['Inter']">
      ...
      {/* ── Score cards ── */}
      <div className="max-w-6xl mx-auto px-8 -mt-1">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
          ...
          {ROWS.map((row, i) => (
            <div
              key={row.dimension}
              className={`grid grid-cols-[220px_1fr_1fr] border-b border-slate-50 hover:bg-slate-50/60 transition-colors ${i === ROWS.length - 1 ? "border-b-0" : ""}`}
            >
              {/* Dimension label */}
