...
<head>
  ...
  <title>${title} | Nexalytics GEO</title>
  <meta name="description" content="${title} — how Nexalytics GEO measures AI search visibility and produces rankings.">
...
function methodologyHtml(base: string): string {
  return shell({
    ...
    body: `
<h1>Methodology</h1>
<p class="lead">How Nexalytics GEO measures AI search visibility across ChatGPT, Claude, Gemini and Perplexity.</p>

<h2>Overview</h2>
<p>Nexalytics GEO runs structured prompt sets across four major AI engines and records which brands appear, their position, and the sources cited. Rankings are derived from appearance frequency — not paid placement or manual curation.</p>
...
<div class="card">
  ...
  <p>Nexalytics GEO analyses the brands that appear in AI responses. Brands not mentioned by AI engines are not ranked — their absence is itself a signal of low AI visibility, not necessarily low quality.</p>
</div>
