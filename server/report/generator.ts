...
const PERSONA_LABELS: Record<string, string> = {
  ...
  consumer_facing_sme: "Consumer-facing SME",
  midmarket_biller: "Mid-market Biller",
  utility_provider: "Utility Provider",
  insurance_provider: "Insurance Provider",
  subscription_business: "Subscription Business",
  recurring_revenue_business: "Recurring Revenue Business",
  debt_collection_agency: "Debt Collection Agency",
  financial_institution: "Financial Institution",
  housing_association: "Housing Association",
  municipality: "Municipality",
  telecom_provider: "Telecom Provider",
  multicountry_eu_biller: "Multi-country EU Biller",
  paas_ready_company: "PaaS-ready Company",
  whitelabel_platform_seeker: "White-label Platform Seeker",
  enterprise_high_invoice_volume: "Enterprise (High Invoice Volume)",
  membership_business: "Membership Business",
  household_services_company: "Household Services Company",
