...
const PERSONA_LABELS: Record<string, string> = {
  ...
  invoice_reminder_software: "Invoice Reminder Software",
  payment_reminder_software: "Payment Reminder Software",
  collections_automation_platform: "Collections Automation Platform",
  invoice_collection_software: "Invoice Collection Software",
  accounts_receivable_automation_software: "AR Automation Software",
  debt_collection_software: "Debt Collection Software",
  collections_software: "Collections Software",
  invoice_chasing_software: "Invoice Chasing Software",
  receivables_automation_platform: "Receivables Automation Platform",
  whitelabel_collections_software: "White-label Collections Software",
  whitelabel_payment_reminder_software: "White-label Payment Reminder Software",
  dunning_software: "Dunning Software",
  digital_collections_platform: "Digital Collections Platform",
  ar_workflow_automation_software: "AR Workflow Automation Software",
  sme_collections_software: "SME Collections Software",
  midmarket_collections_platform: "Mid-market Collections Platform",
  paas_collections_platform: "PaaS Collections Platform",
