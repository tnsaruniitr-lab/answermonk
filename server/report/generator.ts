...
const PERSONA_LABELS: Record<string, string> = {
  ...
  invoice_reminder_software: "Invoice Reminder",
  payment_reminder_software: "Payment Reminder",
  collections_automation_platform: "Collections Automation",
  invoice_collection_software: "Invoice Collection",
  accounts_receivable_automation_software: "AR Automation",
  debt_collection_software: "Debt Collection",
  collections_software: "Collections",
  invoice_chasing_software: "Invoice Chasing",
  receivables_automation_platform: "Receivables Automation",
  whitelabel_collections_software: "White-label Collections",
  whitelabel_payment_reminder_software: "White-label Payment Reminder",
  dunning_software: "Dunning",
  digital_collections_platform: "Digital Collections",
  ar_workflow_automation_software: "AR Workflow Automation",
  sme_collections_software: "SME Collections",
  midmarket_collections_platform: "Mid-market Collections",
  paas_collections_platform: "PaaS Collections",
  debt_recovery_software: "Debt Recovery",
  first_party_collections_software: "First-party Collections",
  eu_payment_link_software: "EU Payment Link",
