...
export function recommendActions(
  ...
  if (categoryGap && audienceGap) {
    return {
      ...
      secondary: comparativeGap ? buildComparativeAction(evidence) : null,
      gapType: "category",
    };
  }
  ...
  if (comparativeGap) {
    return {
      primary: buildComparativeAction(evidence),
      secondary: authorityGap ? buildAuthorityAction(evidence) : null,
      gapType: "comparative",
    };
  }
  ...
  if (authorityGap) {
    return {
      primary: buildAuthorityAction(evidence),
      secondary: null,
      gapType: "authority",
    };
  }
...
function buildComparativeAction(evidence: SegmentEvidence): string {
...
function buildAuthorityAction(evidence: SegmentEvidence): string {
