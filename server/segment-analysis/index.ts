...
const PERSONA_CORE_LABELS: Record<string, string> = {
  ...
  consumer_facing_sme: "credit management",
  midmarket_biller: "credit management",
  utility_provider: "credit management",
  insurance_provider: "credit management",
  subscription_business: "credit management",
  recurring_revenue_business: "credit management",
  debt_collection_agency: "credit management",
  financial_institution: "credit management",
  housing_association: "credit management",
  municipality: "credit management",
  telecom_provider: "credit management",
  multicountry_eu_biller: "credit management",
  paas_ready_company: "credit management",
  whitelabel_platform_seeker: "credit management",
  enterprise_high_invoice_volume: "credit management",
  membership_business: "credit management",
  household_services_company: "credit management",
  government_agency: "credit management",
  healthcare_provider: "credit management",
  bnpl_provider: "credit management",
